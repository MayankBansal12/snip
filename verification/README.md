...
Machine-readable results: [report.json](report.json) and [interaction-report.json](interaction-report.json). Absolute output paths refer to local test artifacts, not public endpoints.
