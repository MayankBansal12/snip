...
- The completed export dialog shows details read from the rendered file, including codec, dimensions, average frame rate, audio settings, and original duration. Large or 4K exports can exceed browser memory; saving the project allows a retry after reopening.
