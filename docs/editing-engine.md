...
On the landing page, hover or tap **edit with your agent** to copy a complete setup prompt with MCP configuration. Editing commands use JSON internally; the editor does not expose a JSON editing panel.
