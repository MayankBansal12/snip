...
Chat contains a prompt field with send, undo, and redo. Feedback appears only while processing or after an edit. For manual zoom adjustments, switch to the editor and open **zoom** to drag the focus box. “Zoom needs to be in top left side” keeps an existing magnification; without a zoom, it starts at 1.5×. “Trim 5 seconds” removes the first five seconds; “trim to 5 seconds” keeps the first five. The result states the applied edit.
