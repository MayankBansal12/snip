...
const tools = [
  ...
  {name:'get_export_status',description:'Read the latest browser export job: running, complete, failed, or cancelled, plus progress, filename/size, and measured output details (dimensions, duration, frame rate, codecs, audio). Complete means the browser has a downloadable Blob; it does not prove the user saved it. Returns null before any export.',inputSchema:empty},
];
