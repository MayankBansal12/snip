...
const groups = [
  { title: 'playback', items: [
    ['play / pause', 'space'], ['previous / next source frame', '← / →'], ['move 1 second', 'Shift', '← / →'],
  ...
  { title: 'editing', items: [
    ['open focused clip adjustments', 'enter'], ['merge neighboring clip', 'm'], ['zoom presets / reverse', 'z / shift z'], ['move clip earlier / later', 'alt', '↑ / ↓'], ['trim start by one frame', 'alt', '← / →'], ['trim end by one frame', 'alt', 'shift', '← / →'], ['split at playhead', 'S'], ['trim clip start to playhead', 'I'], ['trim clip end to playhead', 'O'],
